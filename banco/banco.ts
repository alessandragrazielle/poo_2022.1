import { AplicacaoError, ContaInexistenteError, ContaJaCadastradaError, PoupancaInvalidaError, SaldoInsuficienteError, ValorInvalidoError } from "./excecoes";
...
/*let c1: Conta = new Conta('01', 200);
let c2: Conta = new Poupanca('02', 20, 5);
let c3: Conta = new ContaImposto('01', 2000, 10);
